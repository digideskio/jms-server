...
function ModuleRequest (server, options, next) {
	...
	server.ext('onPreHandler', function (request, reply) {
		...
		moduleRequest.multiClient = !!moduleRequest.params.multiple;
		moduleRequest.callInit = moduleRequest.params.call;

		moduleRequest.source = request.params.source;
		moduleRequest.stage = request.params.stage;

		if (request.server.settings.app.context && request.server.settings.app.context.local) {
